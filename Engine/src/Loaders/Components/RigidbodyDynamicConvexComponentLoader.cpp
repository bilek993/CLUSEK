#include "RigidbodyDynamicConvexComponentLoader.h"

#include "../../ECS/Components/RigidbodyDynamicConvexComponent.h"

void RigidbodyDynamicConvexComponentLoader::Add(nlohmann::json& json, entt::registry& registry,
                                                const entt::registry::entity_type& entity)
{
	auto &component = registry.assign<RigidbodyDynamicConvexComponent>(entity);
